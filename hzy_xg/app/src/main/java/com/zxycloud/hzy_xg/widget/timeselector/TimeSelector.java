package com.zxycloud.hzy_xg.widget.timeselector;
...
import com.zxycloud.hzy_xg.widget.timeselector.Utils.DateUtil;
import com.zxycloud.hzy_xg.widget.timeselector.Utils.ScreenUtil;
import com.zxycloud.hzy_xg.widget.timeselector.view.PickerView;
...
public class TimeSelector {
    ...
    private void initParameter() {
        startYear = startCalendar.get(Calendar.YEAR)-1;
    ...
    private void loadComponent() {
        ...
        if (showTimes == null) {
            ...
            month_pv.setSelected(showTimes.get(0));
            day_pv.setSelected(showTimes.get(1));
            hour_pv.setSelected(showTimes.get(2));
            minute_pv.setSelected(showTimes.get(3));
        }
        excuteScroll();
        initCalender();
    }
