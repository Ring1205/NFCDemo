package com.zxycloud.hzy_xg.widget.CustomAlertDialog;
...
public class CustomAlertDialogFactory {
     ...
     * @return the title
     */
    public CustomAlertDialogFactory setTitle(int title) {
     ...
     * @return the content
     */
    public CustomAlertDialogFactory setContent(int content) {
     ...
     * @return the cancel
     */
    public CustomAlertDialogFactory setCancel(int cancel) {
     ...
     * @return the confirm
     */
    public CustomAlertDialogFactory setConfirm(int confirm) {
