...
public class DBManager {
    ...
    public List<String> getAllHistoryAccount(String tableName) {
        ...
        while (mCursor.moveToNext()) {
            String columnValues = mCursor.getString(mCursor.getColumnIndex(DbUtils.USER_ACCOUNT));
            accounts.add(columnValues);
        }
        return accounts;
    }
     ...
     * @return
     */
    public UserAccountBean hasThisAccount(String tableName, String[] columnName, String[] data) {
        ...
        while (mCursor.moveToNext()) {
            ...
            if (hasUser) {
                ...
                bean.setAccount(mCursor.getString(mCursor.getColumnIndex(DbUtils.USER_ACCOUNT)));
                bean.setPassword(mCursor.getString(mCursor.getColumnIndex(DbUtils.USER_PASSWORD)));
                bean.setRememberPW(Boolean.parseBoolean(mCursor.getString(mCursor.getColumnIndex(DbUtils.REMEMBER_PW))));
                break;
            }
        }
        closeAll();
