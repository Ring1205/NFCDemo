...
public class GraphicVerificationCodeUtil {
    ...
    private static GraphicVerificationCodeUtil bmpCode;

    public static GraphicVerificationCodeUtil getInstance() {
        if (bmpCode == null)
            bmpCode = new GraphicVerificationCodeUtil();
        return bmpCode;
    }
    ...
    private int randomColor(int rate) {
        int red = random.nextInt(187) / rate;
        int green = random.nextInt(187) / rate;
        int blue = random.nextInt(187) / rate;
